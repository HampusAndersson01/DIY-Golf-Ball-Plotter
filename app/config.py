...
class Config:
    ...
    DEFAULT_LINE_THICKNESS_MM = _env_float("DEFAULT_LINE_THICKNESS_MM", 0.3)
    ...
    DEFAULT_INFILL_SPACING_MM = _env_float("DEFAULT_INFILL_SPACING_MM", 0.3)
    ...
    DEFAULT_MIN_FILL_WIDTH_MM = _env_float("DEFAULT_MIN_FILL_WIDTH_MM", 0.3)
